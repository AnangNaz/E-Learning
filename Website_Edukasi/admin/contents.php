...
<div class="box-container">
   ...
   <div class="box" data-type="materi" style="text-align:center;">
      <h3 class="title">Tambah Materi</h3>
      <a href="add_materi.php" class="btn">add materi</a>
   </div>

   <!-- Tombol tambah soal -->
   <div class="box" data-type="soal" style="text-align:center;">
      <h3 class="title">Tambah Soal</h3>
      <a href="add_soal.php" class="btn">add soal</a>
   </div>
...
?>
   <div class="box" >
      ...
      <form method="post" class="flex-btn">
         ...
         <a href="update_content.php?get_id=<?= $row['id']; ?>" class="option-btn">update</a>
         <button type="submit" name="delete_video" class="delete-btn" onclick="return confirm('Hapus video ini?');">delete</button>
      </form>

      <a href="view_content.php?get_id=<?= $row['id']; ?>" class="btn">view</a>
   </div>
<?php
   }
}else{
...
<h2 class="heading">Materi (PDF / DOC)</h2>
...
<form method="post" class="flex-btn">
    ...
    <button type="submit" name="delete_soal" class="delete-btn" 
            onclick="return confirm('Hapus soal ini?');">delete</button>
</form>
